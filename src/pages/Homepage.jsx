  ...
  return [
    ...
    <section>
     <div className="mt-10 ml-16 p-10 max-w-[1000px] text-justify scroll-smooth">
      <div className="mx-auto ml-5 font-navFont text-3xl mb-10">About Us </div>
      <div className="mx-auto ml-5 font-navFont tracking-wider">
        {" "}
    ...
    <div className=" ml-16 p-10 max-w-[1000px] text-justify scroll-smooth " >
      <div className="mx-auto ml-5 font-navFont text-3xl mb-10 ">
        Practice Areas
      </div>
      <div className="mx-auto ml-5 font-navFont tracking-wider">
        Our team of seasoned professionals is dedicated to providing top-notch
        legal services across various specialties. With a focus on excellence
        and a commitment to delivering results, we strive to exceed our clients'
        expectations in every case. <br /> <br /> Explore our practice areas
        below to discover how Black Swan can assist you in navigating
        the complexities of the legal landscape with confidence and clarity.
      </div>
    </div>
    <div className=" container grid grid-cols-4 mt-1 mx-auto p-7 gap-x-3 font-navFont  ">
      <div className="card w-75 bg-base-100 shadow-xl image-full hover:-translate-y-6 transition-all duration-100 hover:brightness-200" >
        ...
        <div className="card-body">
          <h2 className="card-title text-center">Corporate & Commercial Law</h2>
      ...
      <div className="card w-75 bg-base-100 shadow-xl image-full hover:-translate-y-6 transition-all duration-100 hover:brightness-200">
        ...
        <div className="card-body">
          <h2 className="card-title text-center">Intellectual Property & Technology</h2>
     ...
     Visit our Expertise Page <svg className="w-4 ml-3" dataSlot="icon" fill="none" strokeWidth={2} stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
   <path strokeLinecap="round" strokeLinejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />
    ...
    <div className=" ml-16 p-10 max-w-[1000px] text-justify scroll-smooth ">
    <div className="mx-auto  font-navFont text-3xl mb-12 text-black">
   Latest Insights
    </div>
    <div className="grid grid-cols-6 gap-x-7 font-navFont">
          <div className="col-span-4 ">
            ...
            <div className="card lg:card-side bg-base-100  rounded-md cursor-pointer  duration-700 hover:animate-pulse p-2">
              ...
              <div className="card-body ">
                <h2 className="card-title font-semibold">An Overview of Ghana's Consumer Protection Laws</h2>
                <p className="">04 April,2024</p>
                <div className="card-actions justify-start">
                  <button className="btn btn-outline px-10 hover:bg-black  hover:text-white">Read more</button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col border-l py-5 px-5 hover:border-swanblack hover:animate-pulse duration-700" >
              <div className="flex ">
                ...
                <div className="p-5 flex-row">
                  <h1 className="font-semibold ">An Overview of the Tax Incentives Available to Operators in the Ghanaian Mining Industry</h1>
          ...
          <div className="flex flex-col border-l hover:border-swanblack py-5 px-5 hover:animate-pulse duration-700 mt-2 " >
              <div className="flex ">
                ...
                ></img>
                <div className="p-5 flex-row">
                  <h1 className="font-semibold ">Data Breaches: Compliance obligations under the Ghanaian Data Protection Act 2012 (Act 843)</h1>
